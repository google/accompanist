...
/**
 * A private class to do all the drawing of SwipeRefreshIndicator like the [CircularProgressPainter]
 * but it inverse the progress bar rotation and the arrow direction.
 */
// TODO Refactor the [CircularProgressPainter] and extends from it.
internal class BottomCircularProgressPainter : Painter() {
    var color by mutableStateOf(Color.Unspecified)
    var alpha by mutableStateOf(1f)
    var arcRadius by mutableStateOf(0.dp)
    var strokeWidth by mutableStateOf(5.dp)
